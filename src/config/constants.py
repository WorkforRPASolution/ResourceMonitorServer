...
# Phase 1: metric category classification for email sub_code
ALERT_CATEGORY_CPU = "CPU"
ALERT_CATEGORY_MEMORY = "MEMORY"
ALERT_CATEGORY_DISK = "DISK"
ALERT_CATEGORY_GPU = "GPU"
ALERT_CATEGORY_TEMPERATURE = "TEMPERATURE"
ALERT_CATEGORY_PROCESS_WATCH = "PROCESS_WATCH"
ALERT_CATEGORY_RESOURCE = "RESOURCE"  # fallback
